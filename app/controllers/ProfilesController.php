...
use MediaRatings\Forms\ProfilesForm;
use MediaRatings\Models\Profiles;

/**
 * MediaRatings\Controllers\ProfilesController
...
class ProfilesController extends ControllerBase
{
    ...
    public function searchAction()
    {
        ...
        if ($this->request->isPost()) {
            $query = Criteria::fromInput($this->di, 'MediaRatings\Models\Profiles', $this->request->getPost());
